$rhap_theme-color: #00bc8c !default;
$rhap_background-color: #404040 !default;
$rhap_bar-color: #dddddd !default;
$rhap_time-color: #fff !default;
$rhpa_progress-button: lighten($color: #404040, $amount: 15%);
...
.rhap_progress-indicator {
  ...
  margin-left: -10px;
  top: -8px;
  background: $rhpa_progress-button;
  border-radius: 50px;
  box-shadow: rgba($rhpa_progress-button, .5) 0 0 5px;
}
...
.rhap_volume-bar {
  ...
  width: 100%;
  height: 4px;
  background: rgba($rhap_bar-color, 0.5);;
  border-radius: 2px;
}
